 ...
 * @param {String} [options.searchpath=''] search path relative to {@link module:hive-conf/lib/overrides.PACKAGE_PATH|PACKAGE_PATH} to look for package files to load
