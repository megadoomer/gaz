...
/**
 * String utilities
 * @module alice-stdlib/string
 * @author Eric Satterwhite
 * @since 0.1.0
 * @requires mout/string
 * @requires alice-stdlib/string/clean
 * @requires alice-stdlib/string/capitalize
 * @requires alice-stdlib/string/from
 * @requires alice-stdlib/string/id
 * @requires alice-stdlib/string/pluralize
 * @requires alice-stdlib/string/pxToInt
 * @requires alice-stdlib/string/randomKey
 * @requires alice-stdlib/string/reverse
 * @requires alice-stdlib/string/smartPlural
 * @requires alice-stdlib/string/split
 * @requires alice-stdlib/string/toFloat
 * @requires alice-stdlib/string/toInt
 */
...
/**
 * @function 
 * @see module:alice-stdlib/string/from
 **/
 ...
 * @function
 * @see module:alice-stdlib/string#unescapeUnicode
 ...
 * @function
 * @see module:alice-stdlib/string#slugify
 * @see module:alice-stdlib/string#underscore
 * @see module:alice-stdlib/string#unhyphenate
 ...
 * @function
 * @see module:alice-stdlib/string#camelCase
...
/**
 * @function 
 * @see module:alice-stdlib/string/pluralize
 **/
...
/**
 * @function 
 * @see module:alice-stdlib/string/pxToInt
 **/
exports.pxToInt             = require('./pxToInt')
/**
 * @function 
 * @see module:alice-stdlib/string/randomKey
 **/
exports.randomKey           = require('./randomKey')
/**
 * @function 
 * @see module:alice-stdlib/string/reverse
 **/
 ...
 * Pad string with `char` if its' length is smaller than `minLen`
 * @function
 * @see module:alice-stdlib/string#lpad
 ...
 * @see module:alice-stdlib/string#trim
 * @see module:alice-stdlib/string#ltrim
 * @function
 ...
 * @function
 * @see module:alice-stdlib/string#hphenate
 * @see module:alice-stdlib/string#underscore
...
/**
 * @function 
 * @see module:alice-stdlib/string/smartPlural
 **/
exports.smartPlural         = require('./smartPlural')
/**
 * @function 
 * @see module:alice-stdlib/string/split
 **/
...
/**
 * @function 
 * @see module:alice-stdlib/string/toFloat
 **/
exports.toFloat             = require('./toFloat')

/**
 * @function 
 * @see module:alice-stdlib/string/toInt
 **/
 ...
 * @function
 * @see module:alice-stdlib/string#slugify
 * @see module:alice-stdlib/string#hyphenate
 ...
 * @function
 * @see module:alice-stdlib/string#escapeHtml
